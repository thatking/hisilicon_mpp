...
void SAMPLE_VIO_Usage(char* sPrgNm)
{
    ...
    printf("\t 4)offline mode VI(ROTATE); VO(0:LCD, 1:BT656).Embeded isp, offline, rotate, phychn channel preview.\n");
    printf("\t 5)offline mode VI(LDC); VO(0:LCD, 1:BT656).Embeded isp, offline, LDC, phychn channel preview.\n");
    printf("\t 6)offline mode VI(DIS); VO(0:LCD, 1:BT656).Embeded isp, offline, DIS, phychn channel preview.\n");
    printf("\t 7)offline mode VI: BT1120; VO(0:LCD, 1:BT656).Isp bypass, phychn channel preview.\n");

#if (CHIP_ID != CHIP_HI3518E_V201)
    printf("\t 8)offline mode VI; VO(0:LCD, 1:BT656).Embeded isp, resolution switch.\n");
#endif
...
HI_S32 SAMPLE_VIO_FRAME_FPN_PreView(SAMPLE_VI_CONFIG_S* pstViConfig)
{
    ...
    ******************************************/
    ...
    ISP_OP_TYPE_E  enOpType = OP_TYPE_MANUAL; /* auto/manual */
...
HI_S32 SAMLE_VIO_ResolutionSwitch_Preview(SAMPLE_VI_CONFIG_S* pstViConfig)
{
    ...
    if ( SONY_IMX122_DC_1080P_30FPS == pstViConfig->enViMode
         || SONY_IMX122_DC_720P_30FPS == pstViConfig->enViMode )
    {
