...
HI_S32 main(int argc, char* argv[])
{
	...
	if (argc == 4 && 0 != strcmp(para, "mqpdelta")&&0 != strcmp(para, "level")&&0 != strcmp(para, "maxqp")\
		&&0 != strcmp(para, "qpdelta")&&0 != strcmp(para, "flut")&&0 != strcmp(para, "gop")&&0 != strcmp(para, "framerate")\
		&&0 != strcmp(para, "bitrate")&&0 != strcmp(para, "stattime"))
	{
		printf("\n\tthe parameter is not right,please check\n");
		USAGE_HELP();	
		return -1;
	}
	...
	{
		printf("\n\tthe parameter cnt is not right,please check\n");
		USAGE_HELP();	
		return -1;
	}
