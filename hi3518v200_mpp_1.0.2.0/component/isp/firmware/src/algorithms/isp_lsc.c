...
static HI_VOID LscReadExtRegs(ISP_DEV IspDev)
{
	...
	u16Wb_RGain = hi_isp_awb_avg_r_read();
	u16Wb_GGain = hi_isp_awb_avg_g_read();
	u16Wb_BGain = hi_isp_awb_avg_b_read();
	...
	pstLsc->au16Wbgain[0] = (HI_FLOAT)u16Wb_RGain / DIV_0_TO_1(u16Wb_GGain) * 1024;
	pstLsc->au16Wbgain[1] = (HI_FLOAT)u16Wb_BGain / DIV_0_TO_1(u16Wb_GGain) * 1024;
}
