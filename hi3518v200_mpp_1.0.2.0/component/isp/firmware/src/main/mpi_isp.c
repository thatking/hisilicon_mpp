...
extern HI_S32 HI_MPI_VI_SetDISAttr(VI_DEV ViDev, const VI_DIS_ATTR_S *pstDISAttr);
HI_S32 HI_MPI_ISP_SetDISAttr(ISP_DEV IspDev, const ISP_DIS_ATTR_S *pstDISAttr)
{
    ...
    return HI_MPI_VI_SetDISAttr(0, (VI_DIS_ATTR_S *)pstDISAttr);
}

extern HI_S32 HI_MPI_VI_GetDISAttr(VI_DEV ViDev, VI_DIS_ATTR_S *pstDISAttr);
HI_S32 HI_MPI_ISP_GetDISAttr(ISP_DEV IspDev, ISP_DIS_ATTR_S *pstDISAttr)
{
    ...
    return HI_MPI_VI_GetDISAttr(0, (VI_DIS_ATTR_S *)pstDISAttr);
}
...
HI_S32 HI_MPI_ISP_GetStatistics(ISP_DEV IspDev, ISP_STATISTICS_S *pstStat)
{
    ...
    //if (pstStat->unKey.bit1AeStat3)
    {
        ...
        for(i = 0; i < 256; i++)
        {
            pstStat->stAEStat.au32Hist256Value[i] = hi_isp_ae_mem_hist_rdata_read();
        }
    }
    ...
    //if (pstStat->unKey.bit1AeStat5)
    {
        ...
        for(i = 0;i < AE_ZONE_ROW ; i++)
        {
            ...
            {           
                ...
                pstStat->stAEStat.au16ZoneAvg[i][j][0] = (HI_U8)((u32AveMem & 0xff000000) >> 24);  /*R */
                pstStat->stAEStat.au16ZoneAvg[i][j][1] = (HI_U8)((u32AveMem & 0xff0000) >> 16);    /*Gr*/
                pstStat->stAEStat.au16ZoneAvg[i][j][2] = (HI_U8)((u32AveMem & 0xff00) >> 8);       /*Gb*/
                pstStat->stAEStat.au16ZoneAvg[i][j][3] = (HI_U8)((u32AveMem & 0xff));              /*B */
            }       
        }
    }
