        ...
        ISP_AE_REGISTER_S *pstRegister)
{
    ...
    ISP_AE_CHECK_HANDLE_ID(pstAeLib->s32Id);
    ISP_AE_CHECK_LIB_NAME(pstAeLib->acLibName);
    ISP_CHECK_POINTER(pstRegister);
        ...
        ISP_AWB_REGISTER_S *pstRegister)
{
    ...
    ISP_AWB_CHECK_HANDLE_ID(pstAwbLib->s32Id);
    ISP_AWB_CHECK_LIB_NAME(pstAwbLib->acLibName);
    ISP_CHECK_POINTER(pstRegister);
        ...
        ISP_AF_REGISTER_S *pstRegister)
{
    ...
    ISP_AF_CHECK_HANDLE_ID(pstAfLib->s32Id);
    ISP_AF_CHECK_LIB_NAME(pstAfLib->acLibName);
    ISP_CHECK_POINTER(pstRegister);
...
HI_S32 HI_MPI_ISP_GetVDTimeOut(ISP_DEV IspDev, ISP_VD_INFO_S *pstIspVdInfo, HI_U32 u32MilliSec)
{
    ...
    ISP_CHECK_DEV(IspDev);
    ISP_CHECK_OPEN(IspDev);
	ISP_CHECK_POINTER(pstIspVdInfo);
