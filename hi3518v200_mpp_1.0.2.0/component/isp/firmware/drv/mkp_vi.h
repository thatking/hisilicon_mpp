...
{
    VI_RAW_DATA_INFO_S* pstRawDataInfo;
    HI_S32              s32MilliSec;
...
typedef enum hiIOC_NR_VIU_E
{
    ...
    IOC_NR_VIU_DIS_ATTR_SET_NEW_CTRL,
    IOC_NR_VIU_DIS_ATTR_GET_NEW_CTRL,

    IOC_NR_VIU_DIS_DISABLE_CTRL,

    IOC_NR_VIU_PYRAMID_INFO_GET,
    IOC_NR_PYRAMID_STATE_GET,
    IOC_NR_AFFINE_STATE_GET
#endif
} IOC_NR_VIU_E;
...
#define VIU_SEND_BAYER_DATA                 _IOW(IOC_TYPE_VIU, IOC_NR_VIU_SEND_BAYER_DATA, VI_RAW_DATA_INFO_S)
...
#define VIU_DIS_INFO_GET                    _IOR(IOC_TYPE_VIU, IOC_NR_VIU_DIS_INFO_GET, VI_DIS_INFO_S)
...
#define VIU_DIS_ATTR_SET_NEW_CTRL           _IOW(IOC_TYPE_VIU, IOC_NR_VIU_DIS_ATTR_SET_NEW_CTRL,VI_DIS_DYNAMIC_ATTR_S)
#define VIU_DIS_ATTR_GET_NEW_CTRL           _IOR(IOC_TYPE_VIU, IOC_NR_VIU_DIS_ATTR_GET_NEW_CTRL,VI_DIS_DYNAMIC_ATTR_S)

#define VIU_PYRAMID_STATE_GET               _IOR(IOC_TYPE_VIU, IOC_NR_PYRAMID_STATE_GET, HI_BOOL)
#define VIU_AFFINE_STATE_GET                _IOR(IOC_TYPE_VIU, IOC_NR_AFFINE_STATE_GET, HI_BOOL)
#endif
