...
typedef union hiISP_REG_KERNEL_CFG_KEY_U
{
    ...
    struct
    {
        ...
        HI_U32  bit1LscCfg      : 1 ;   /* [1]*/
        HI_U32  bit20Rsv        : 30;   /* [2:31] */
    };
...
#define ISP_LSC_UPDATE_MODE_GET _IOR(IOC_TYPE_ISP, IOC_NR_LSC_UPDATE_MODE_GET, HI_U32)
