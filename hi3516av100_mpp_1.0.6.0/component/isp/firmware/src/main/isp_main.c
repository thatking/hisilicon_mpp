...
HI_S32 ISP_WDRCfgSet(ISP_DEV IspDev)
{
    ...
    {
        hi_isp_interrupts_interrupt0_source_write(HI_ISP_INTERRUPTS_INTERRUPT0_SOURCE_VALUE);   /* statistics ready interrupt */
        hi_isp_interrupts_interrupt1_source_write(24);   /* frame start interrupt */
    }
    else if (IS_LINE_WDR_MODE(stWDRCfg.u8WDRMode))
    {
        hi_isp_interrupts_interrupt0_source_write(24);  /* frame start interrupt */
        hi_isp_interrupts_interrupt1_source_write(0);   /* no interrupt */
    }
    else
    {
        hi_isp_interrupts_interrupt0_source_write(HI_ISP_INTERRUPTS_INTERRUPT0_SOURCE_VALUE);   /* statistics ready interrupt */
