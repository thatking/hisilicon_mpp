...
typedef enum hiMPP_DATA_TYPE_E
{
    ...
    MPP_DATA_VPSS_FRAME,    /* VIDEO_FRAME_INFO_S   */
...
#define BIND_ADJUST_2ND_DEST_CHNID(enModId ,s32ChnId)\
    do{\
        if (HI_ID_GROUP == enModId || HI_ID_VPSS == enModId)\
        {\
            s32ChnId = 0;\
        }\
    }while(0)
