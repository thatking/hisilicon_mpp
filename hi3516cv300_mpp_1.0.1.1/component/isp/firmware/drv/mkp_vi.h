...
typedef struct hiVI_USR_GET_RAW_TIMEOUT_S
{
    VI_RAW_FRAME_INFO_S       stVFrame;
    HI_S32              s32MilliSec;
} VI_USR_GET_RAW_TIMEOUT_S;
typedef struct hiVI_USR_SEND_RAW_TIMEOUT_S
{
    VI_RAW_DATA_INFO_S**  ppstRawDataInfo;
    HI_U32                u32SRCNum;
    HI_S32                s32MilliSec;
} VI_USR_SEND_RAW_TIMEOUT_S;

typedef struct hiVI_SEND_RAW_TIMEOUT_S
{
    VI_RAW_FRAME_INFO_S*        pstRawDataInfo;
    HI_S32                s32MilliSec;
} VI_SEND_RAW_TIMEOUT_S;
...
typedef enum hiIOC_NR_VIU_E
{
    ...
    IOC_NR_VIU_CHN_ROTATE_EX_ATTR_SET,
    IOC_NR_VIU_CHN_ROTATE_EX_ATTR_GET,
	...
	IOC_NR_VIU_SEND_RAW_DATA,

    IOC_NR_VIU_DIS_ATTR_SET,
    IOC_NR_VIU_DIS_ATTR_GET,

	IOC_NR_VIU_BAYER_READ_ATTR_SET,
	IOC_NR_VIU_BAYER_READ_ATTR_GET,
    ...
    IOC_NR_VIU_DIS_EXIT_FLAG_SET,
#endif
	IOC_NR_VIU_CHN_STITCHING_ATTR_SET,
	IOC_NR_VIU_CHN_STITCHING_ATTR_GET,
	IOC_NR_VIU_CHN_SPREAD_ATTR_SET,
	IOC_NR_VIU_CHN_SPREAD_ATTR_GET,
	IOC_NR_VIU_DEV_BIND,	
	IOC_NR_VIU_DEV_GET_BIND,
	 IOC_NR_SNAP_ATTR_SET,
    IOC_NR_SNAP_ATTR_GET,
    IOC_NR_SNAP_ENABLE,
    IOC_NR_SNAP_DISABLE,
    IOC_NR_SNAP_TRIGGER,
    IOC_NR_MUTLI_TRIGGER,
    IOC_NR_VIU_RAW_GET,
} IOC_NR_VIU_E;
...
#define VIU_RAW_GET_CTRL                    _IOWR(IOC_TYPE_VIU, IOC_NR_VIU_RAW_GET, VI_USR_GET_RAW_TIMEOUT_S)
...
#define VIU_CHN_ROTATE_EX_SET_CTRL          _IOW(IOC_TYPE_VIU, IOC_NR_VIU_CHN_ROTATE_EX_ATTR_SET, VI_FISHEYE_ROTATEEX_ATTR_S)
#define VIU_CHN_ROTATE_EX_GET_CTRL          _IOR(IOC_TYPE_VIU, IOC_NR_VIU_CHN_ROTATE_EX_ATTR_GET, VI_ROTATE_EX_ATTR_S)
...
#define VIU_SEND_RAW_DATA                   _IOW(IOC_TYPE_VIU, IOC_NR_VIU_SEND_RAW_DATA, VI_SEND_RAW_TIMEOUT_S)

#define VIU_BAYER_READ_ATTR_SET_CTRL        _IOWR(IOC_TYPE_VIU, IOC_NR_VIU_BAYER_READ_ATTR_SET, VI_BAYER_READ_ATTR_S)
#define VIU_BAYER_READ_ATTR_GET_CTRL        _IOR(IOC_TYPE_VIU, IOC_NR_VIU_BAYER_READ_ATTR_GET, VI_BAYER_READ_ATTR_S)
...
#define VIU_DIS_EXIT_FLAG_SET_CTRL          _IOW(IOC_TYPE_VIU, IOC_NR_VIU_DIS_EXIT_FLAG_SET, HI_BOOL)
#endif
...
#define VIU_CHN_STITCHING_SET_CTRL        	_IOW(IOC_TYPE_VIU, IOC_NR_VIU_CHN_STITCHING_ATTR_SET, VI_STITCH_CORRECTION_ATTR_S) // the addr is passed implicitly
#define VIU_CHN_STITCHING_GET_CTRL          _IOR(IOC_TYPE_VIU, IOC_NR_VIU_CHN_STITCHING_ATTR_GET, VI_STITCH_CORRECTION_ATTR_S)
#define VIU_CHN_SPREAD_SET_CTRL        		_IOW(IOC_TYPE_VIU, IOC_NR_VIU_CHN_SPREAD_ATTR_SET, HI_U32) // the addr is passed implicitly
#define VIU_CHN_SPREAD_GET_CTRL         	_IOR(IOC_TYPE_VIU, IOC_NR_VIU_CHN_SPREAD_ATTR_GET, SPREAD_ATTR_S)

#define VIU_DEV_BIND_CTRL        			_IOW(IOC_TYPE_VIU, IOC_NR_VIU_DEV_BIND, VI_DEV_BIND_ATTR_S)
#define VIU_DEV_GETBIND_CTRL          		_IOR(IOC_TYPE_VIU, IOC_NR_VIU_DEV_GET_BIND, VI_DEV_BIND_ATTR_S)
#define VIU_SNAP_ATTR_SET                   _IOW(IOC_TYPE_VIU, IOC_NR_SNAP_ATTR_SET, VI_SNAP_ATTR_S)
#define VIU_SNAP_ATTR_GET                   _IOR(IOC_TYPE_VIU, IOC_NR_SNAP_ATTR_GET, VI_SNAP_ATTR_S)
#define VIU_SNAP_ENABLE                     _IO(IOC_TYPE_VIU, IOC_NR_SNAP_ENABLE)
#define VIU_SNAP_DISABLE                    _IO(IOC_TYPE_VIU, IOC_NR_SNAP_DISABLE)
#define VIU_SNAP_TRIGGER                    _IO(IOC_TYPE_VIU, IOC_NR_SNAP_TRIGGER)
#define VIU_MUTLI_TRIGGER                    _IO(IOC_TYPE_VIU, IOC_NR_MUTLI_TRIGGER)
#ifdef __cplusplus
#if __cplusplus
}
#endif
