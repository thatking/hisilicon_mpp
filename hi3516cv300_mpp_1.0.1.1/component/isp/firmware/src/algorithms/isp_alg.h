...
HI_S32 ISP_AlgRegisterMcds(ISP_DEV IspDev);
HI_S32 ISP_AlgRegisterBas(ISP_DEV IspDev);
...
//HI_S32 ISP_AlgRegisterNddm(ISP_DEV IspDev);
...
static inline HI_VOID ISP_AlgsRegister(ISP_DEV IspDev)
{
	...
	//ISP_AlgRegisterBas(IspDev);
	ISP_AlgRegisterSplit(IspDev);
	ISP_AlgRegisterFlicker(IspDev);
	ISP_AlgRegisterFrameWDR(IspDev);	
	ISP_AlgRegisterBayernr(IspDev);
