...
typedef struct hiISP_DRC_ATTR_S
{
	...
	HI_U8  u8SpatialVar;            /*RW, Range: [0x3, 0xF].Controls the frequency of the spatial filter  */
	HI_U8  u8RangeVar;               /*RW, Range: [0x3, 0xF].Controls the frequency of the range filter*/
...
typedef struct hiISP_AF_CFG_S
{
    ...
    HI_U16                  u16Hsize;       /* RW, Range: [0x1, 2048]. AF image wide.                    */
    HI_U16                  u16Vsize;       /* RW, Range: [0x1, 2048]. AF image hight.                   */
