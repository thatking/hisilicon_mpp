...
SAMPLE_AWB_CTX_S g_astAwbCtx_Sample[MAX_AWB_LIB_NUM] = {{0}};
...
HI_S32 SAMPLE_AWB_IspRegsInit(HI_S32 s32Handle)
{
    ...
    pstRawStatAttr->u16MeteringWhiteLevelAwb = 0xFFFF;
...
HI_S32 SAMPLE_HI_MPI_AWB_Register(ISP_DEV IspDev, ALG_LIB_S *pstAwbLib)
{
...
HI_S32 SAMPLE_HI_MPI_AWB_UnRegister(ISP_DEV IspDev, ALG_LIB_S *pstAwbLib)
{
    HI_S32 s32Ret = HI_SUCCESS;
...
HI_S32 SAMPLE_HI_MPI_AWB_SensorRegCallBack(ISP_DEV IspDev, ALG_LIB_S *pstAwbLib, SENSOR_ID SensorId,
...
HI_S32 SAMPLE_HI_MPI_AWB_SensorUnRegCallBack(ISP_DEV IspDev, ALG_LIB_S *pstAwbLib, SENSOR_ID SensorId)
{
    SAMPLE_AWB_CTX_S *pstAwbCtx = HI_NULL;
    HI_S32  s32Handle;
