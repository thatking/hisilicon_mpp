 ...
 ******************************************************************************
  ...
  Created       : 2015/7/11
  Last Modified :
  Description   : when using the isp debug function, this program will create  a  format of '.dat' for AE,AWB,DEHAZE module ;
                        it will  create a format of '.txt' file for the dehaze module when enable the extern register. 
  Function List :
  History       :
  1.Date        : 2015/7/11
    Author      : c00298856
...
HI_S32 isp_debug(int argc, char* argv[])
#else
