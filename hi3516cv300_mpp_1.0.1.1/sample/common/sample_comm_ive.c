...
HI_S32 SAMPLE_COMM_IVE_StartVo(HI_VOID)
{
	...
	stVoPubAttr.enIntfSync = VO_OUTPUT_PAL;//VO_OUTPUT_1080P30;
	stVoPubAttr.enIntfType = VO_INTF_CVBS;//VO_INTF_BT1120;//VO_INTF_VGA; //VO_INTF_HDMI | VO_INTF_VGA;
