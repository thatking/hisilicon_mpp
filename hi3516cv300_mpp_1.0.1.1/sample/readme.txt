Usage Descriptions of the HiSilicon Hi3516CV300 Sample Programs
...
1. Sample Program File Structure
   sample            # MPP sample program
    ...
    |-- ive          # Ive implementation demo
    |-- audio        # Audio implementation demo
    |-- scene_auto   # Scene_auto implementation demo
    |-- vgs          # VGS implementation demo
    |-- ......    
...
3. Running Descriptions of Sample Programs
   1) Sample program running depends on the media driver. Before running a sample demo program, execute the load35** script in the mpp/ko* to load a specified module.
