                                    ...
                                    HI_CHAR* pchSrcFileName, HI_U16 u16Width, HI_U16 u16Height)
{
    ...
    snprintf(achFileName, 256, "./data/output/sobel/sobelh1.dat");
    ...
    snprintf(achFileName, 256, "./data/output/sobel/sobelh2.dat");
    ...
    snprintf(achFileName, 256, "./data/output/sobel/sobelv1.dat");
    ...
    snprintf(achFileName, 256, "./data/output/sobel/sobelv2.dat");
