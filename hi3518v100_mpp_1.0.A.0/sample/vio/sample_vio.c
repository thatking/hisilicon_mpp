...
void SAMPLE_VIO_Usage(char *sPrgNm)
{
    ...
    printf("\t 5) VI: DC(720P); VO: SD0(CVBS). Embeded isp, linear/wdr change, phychn channel preview.\n");
    printf("intf:\n");
...
int main(int argc, char *argv[])
{
    ...
    switch (*argv[1])
    {
        ...
        /* VI: DC(720P); VO: SD0(CVBS). Embeded isp,  linear/wdr change, phychn channel  preview. */
        case '5':
            s32Ret = SAMPLE_VIO_720P_SensorModeChange_Preview(&g_stViChnConfig);
            break;
