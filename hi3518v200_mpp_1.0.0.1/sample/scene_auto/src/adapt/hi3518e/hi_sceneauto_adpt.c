...
HI_S32 CommSceneautoGetDRCAttr(HI_S32 s32IspDev, ADPT_SCENEAUTO_DRCATTR_S *pstAdptDRCAttr)
{
    ...
    pstAdptDRCAttr->u8LocalMixingBrigtht = stDRCAttr.u8LocalMixingBrigtht;
    pstAdptDRCAttr->u8LocalMixingDark = stDRCAttr.u8LocalMixingDark;
...
HI_S32 CommSceneautoSetDRCAttr(HI_S32 s32IspDev, const ADPT_SCENEAUTO_DRCATTR_S *pstAdptDRCAttr)
{
    ...
    stDRCAttr.u8LocalMixingBrigtht= pstAdptDRCAttr->u8LocalMixingBrigtht;
    stDRCAttr.u8LocalMixingDark   = pstAdptDRCAttr->u8LocalMixingDark;
...
HI_S32 CommSceneautoGetExposureInfo(HI_S32 s32IspDev, ADPT_SCENEAUTO_EXPOSUREINFO_S *pstAdptExposureInfo)
{
    ...
    pstAdptExposureInfo->u16RgbirGain = stIspExpInfo.u16RgbirGain;
