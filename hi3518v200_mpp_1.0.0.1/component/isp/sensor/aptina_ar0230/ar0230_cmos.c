...
static AWB_CCM_S g_stAwbCcm =
{
    5050,
    {
        0x01EF, 0x80B9, 0x8036,
        0x8048, 0x016A, 0x8022,
        0x000C, 0x809B, 0x018F,
    },
        
    3932,
    {
        0x01DD, 0x8095, 0x8048,
        0x8065, 0x017E, 0x8019,
        0x8005, 0x8095, 0x019A,
    },

    2658,
    {
        0x020F, 0x80B8, 0x8057,
        0x8058, 0x0173, 0x801B,
        0x000B, 0x8116, 0x020B,
    }
};
...
{   
    ...
    switch (genSensorMode)
    {
        ...
        case WDR_MODE_BUILT_IN:
            ...
            pstDef->stDrc.u8Asymmetry           = 0x02;
            pstDef->stDrc.u8SecondPole          = 0xB4;
            pstDef->stDrc.u8Stretch             = 0x36;
            pstDef->stDrc.u8LocalMixingBrigtht  = 0x2D;
            pstDef->stDrc.u8LocalMixingDark     = 0x2D;
            pstDef->stDrc.u8LocalMixingThres    = 0x02;
            pstDef->stDrc.u16BrightGainLmt      = 0x7F;
