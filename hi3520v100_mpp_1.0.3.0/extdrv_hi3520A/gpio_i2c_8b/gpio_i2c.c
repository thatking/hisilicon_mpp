...
//#Hi3521  ASIC
//#GPIO13 base : 0x20220000
//#GPIO13_2  / I2C_SDA   / muxctrl_reg82
//#GPIO13_3  / I2C_SCL   / muxctrl_reg83

#ifdef HI_FPGA

#define GPIO_0_BASE 0x20220000
#define SCL_SHIFT_NUM   3
#define SDA_SHIFT_NUM   2
#define SCL                 (0x1 << SCL_SHIFT_NUM)    /* GPIO7 0_7 */
#define SDA                 (0x1 << SDA_SHIFT_NUM)    /* GPIO7 0_6 */
#define GPIO_I2C_SCL_REG    IO_ADDRESS(GPIO_0_BASE + (0x1<<(SCL_SHIFT_NUM+2)))  /* 0x200 */
#define GPIO_I2C_SDA_REG    IO_ADDRESS(GPIO_0_BASE + (0x1<<(SDA_SHIFT_NUM+2)))  /* 0x100 */
#define GPIO_I2C_SCLSDA_REG IO_ADDRESS(GPIO_0_BASE +((0x1<<(SCL_SHIFT_NUM+2))+(0x1<<(SDA_SHIFT_NUM+2))))  /* 0x300 need check */
