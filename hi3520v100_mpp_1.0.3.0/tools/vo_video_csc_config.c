...
/* if you want to use this tool for anther chip, please change here. Now we have support HI3531/HI3521/HI3520A */
#define HI_CHIP HI3531



#define HI3521  0x3521
#define HI3520A 0x3520A 
#define HI3531  0x3531
...
#elif (HI_CHIP == HI3521 || HI_CHIP == HI3520A)
    switch(u32Layer)
    {
        case 0:
        {
...
{    
    ...
    printf("NOTICE: Luma/Contrast/Hue/Satuature [0,100], Gain [0, 0x3f]\n");
    printf("usage: ./vo_video_csc_config [LayerId] [Luma] [Contrast] [Hue] [Satuature] [Gain]. sample: ./vo_video_csc_config 0 50 50 50 50 48\n\n");
}

HI_S32 vo_video_csc_config(HI_U32 u32LayerId, HI_U32 u32Luma, HI_U32 u32Contrast, HI_U32 u32Hue, HI_U32 u32Satuature, HI_U32 u32Gain)
{
    HI_S32      s32Ret;
    CscCoef_S   stCscCoef;
    HI_U8       *pAddr = NULL;
    ...
    vou_cal_csc_matrix(u32Luma, u32Contrast, u32Hue, u32Satuature,
        HAL_CSC_MODE_BT601_TO_BT601, &stCscCoef);
...
HI_S32 main(int argc, char *argv[])
{
    ...
    vo_video_csc_config(u32LayerId, u32Luma, u32Contrast, u32Hue, u32Satuature, u32Gain);
